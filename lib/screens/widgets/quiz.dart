...
class _QuizAppState extends State<QuizApp> {
  ...
  String? name;
  getname() async {
    await repository.infoUser(toekn).then((value) {
      setState(() {
        name = value.name;
      });
    });
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  padd20,
                  normalText(
                      color: lightgrey, size: 18, text: "Welcome to our"),
                  ...
                  normalText(
                      ...
                      size: 16,
                      text:
                          "Ready to test your khnowelge and challenge other?"),
                  // const Spacer(),
